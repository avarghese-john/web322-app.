...
cloudinary.config({
    cloud_name: process.env.CLOUD_NAME || "dwodduol2",
    api_key: process.env.CLOUDINARY_API_KEY || "529856386578851",
    api_secret: process.env.CLOUDINARY_API_SECRET || "DIsmzz2O9f6fbFaAZj0A07ojsGY",
    secure: true
});
